...
function validarCampoGenerico(value, fieldName, validateFunction, validateParameter) {
  const fieldIndex = encontrarIndiceDoCampo(fieldName);

  const isValid = validateParameter && validateFunction(value, validateParameter) || validateParameter && validateFunction(value, validateParameter)
