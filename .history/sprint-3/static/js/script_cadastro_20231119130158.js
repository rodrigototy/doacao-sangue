...
function validarCampoGenerico(
  ...
  let isValid;
    (validateParameter && validateFunction(value, validateParameter)) ||
    (!validateParameter && validateFunction(value));

  if (validateParameter) {
    const isValid = validateFunction(value, validateParameter);
  } else {
