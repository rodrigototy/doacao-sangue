...
const fields = [
  {
    ...
    validate: true,
    validate_function: validarString10,
    formatInput: null,
    nextField: null,
  },
  {
    ...
    validate: true,
    validate_function: validarDataNascimento,
  ...
  },
  {
    ...
    validate: true,
    validate_function: validarEmail,
    formatInput: null,
  ...
  },
  {
    ...
    validate: true,
    validate_function: validarString01,
    formatInput: null,
    nextField: null,
  },
  {
    ...
    validate: true,
    validate_function: validarString04,
    formatInput: null,
    nextField: null,
  },
  {
  ...
  },
  {
    ...
    validate: true,
    validate_function: validarString02,
    formatInput: null,
    nextField: null,
  },
  {
  ...
  },
  {
    ...
    validate: true,
    validate_function: validarTelefone,
...
fields.forEach((field) => {
  ...
  field.input.addEventListener("blur", (e) => {
    if (field.validate) {
      validarCampoGenerico(field.input.value, field.fieldName, field.validate_function);
    } else {
